...
package com.wantflying.Zxing.camera;
...
final class CameraConfigurationManager {
  ...
  void initFromCameraParameters(Camera camera) {
    ...
    System.out.println("Default preview format: " + previewFormat + '/' + previewFormatString);
    WindowManager manager = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
    Display display = manager.getDefaultDisplay();
    screenResolution = new Point(display.getWidth(), display.getHeight());
    System.out.println("Screen resolution: " + screenResolution);
    cameraResolution = getCameraResolution(parameters, screenResolution);
    System.out.println("Camera resolution: " + screenResolution);
  }
  ...
  private static Point getCameraResolution(Camera.Parameters parameters, Point screenResolution) {
    ...
    if (previewSizeValueString != null) {
    	System.out.println("preview-size-values parameter: " + previewSizeValueString);
  ...
  private static Point findBestPreviewSizeValue(CharSequence previewSizeValueString, Point screenResolution) {
    ...
    for (String previewSize : COMMA_PATTERN.split(previewSizeValueString)) {
      ...
      if (dimPosition < 0) {
    	  System.out.println("Bad preview-size: " + previewSize);
        continue;
      }
    ...
    if (maxZoomString != null) {
      try {
        ...
        if (tenDesiredZoom > tenMaxZoom) {
    	  ...
    	  System.out.println("Bad max-zoom: " + maxZoomString);
      }
    }
    ...
    if (takingPictureZoomMaxString != null) {
      try {
        ...
        if (tenDesiredZoom > tenMaxZoom) {
    	  ...
    	  System.out.println("Bad taking-picture-zoom-max: " + takingPictureZoomMaxString);
      }
    }
